...
public class Colonies extends JavaPlugin {
	...
	private final HashMap<UUID, Citizen> citizens = new HashMap<>();
	...
	private void initObjects() throws FileSaveException {
		final FileUtil fUtil = new FileUtil(this);
		new Settings(this);
		
		final InputStream is = getResource("Messages.yml");
		try {
